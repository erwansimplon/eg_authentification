			...
			<div class="front front_login panel" {if isset($reset_token) && isset($id_employee)}style="display:none;"{/if}>
				...
				<form action="#" id="login_form" method="post">
					...
					<div class="form-group">
						<label class="control-label" for="code_employee">{l s='Code Employee' d='Admin.Global'}</label>
						<input name="code_employee" type="text" id="code_employee" class="form-control" value="{if isset($code_employee)}{$code_employee|escape:'html':'UTF-8'}{/if}" autofocus="autofocus" tabindex="1" maxlength="6" placeholder="{l s='Code Employee'}"/>
					</div>
					<div class="form-group">
